"""
colormesh3d.common.projection
===============================
Shared world -> camera -> optical-frame projection utilities.

Consolidates the ROS-body/optical-frame projection math that was
copy-pasted (identically) across four files in the two legacy repos:
point_cloud_coloring.py, atlaspacker.py, viewassignment.py, and
meshgenerator.py.
